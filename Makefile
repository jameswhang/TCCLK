...
NATIVE_DEFINES_$(CONFIG_x86-64) += -DTCC_TARGET_X86_64 -DWITHOUT_LIBTCC
...
$(LIBTCC_OBJ) tcc.o : %.o : %.c $(LIBTCC_INC)
	$(CC) $(NATIVE_DEFINES) $(CPPFLAGS) $(CFLAGS) -o $@ -c $< 
...
#
# Additions to build libtcc as a kernel module
#

obj-m += tcc_module.o

tcc_module: module_all
