...
// add_size_pair
void
add_size_pair(void *p, size_t size)
{
    if (g_ptr_list == NULL) {
...
int
remove_size_pair(void *p, size_t size)
{
...
void
add_pair(void * base, size_t size) 
{
